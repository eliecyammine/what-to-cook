...
import { Dialog, DialogEmptyContent } from '@/components/core/dialog';
...
export default function LoginModal({ searchParams }: { searchParams: { message: string } }) {
  const router = useRouter();

  return (
    <Dialog defaultOpen>
      <DialogEmptyContent onOverlayClick={() => router.back()}>
